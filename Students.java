		...
		public Student(String n,int a,char s,char g,int m1,int m2,int m3)
		{
		 ...
		 public int marks(){
		    ...
		    public static void main(String[] args) {
		        Student s1 = new Student("madhuri", 20, 'A','F', 77,85,75);
		        Student s2 = new Student("Shweta", 21, 'B','F', 50,60,65);
		        Student s3 = new Student("meghna", 22, 'A','F', 90,89,96);
		        Student s4 = new Student("Shish", 23, 'B','M', 79,98,87);
